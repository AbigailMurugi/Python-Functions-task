#Continue with the same program and calculate an 
# individual’s Net Salary using:
# net_salary = gross_salary
#  - (nhif + nhdf + nssf + payee)
...
#net salary
def calc_net(gross_salary,tnhif,tnhdf,tnssf,payee):
    net_salary = gross_salary - (tnhif+tnhdf+tnssf+tpayee)
    return net_salary

tnet_sal = calc_net(gross_salary,tnhif,tnhdf,tnssf,tpayee)
print(f"Net salary {tnet_sal}")